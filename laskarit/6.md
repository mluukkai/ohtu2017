...
Vastauksen tulisi luonnollisesti olla sama kuin edellä. Voi kuitenkin olla, että koodisi ei toimi. Mieti missä vika on ja miten joudut muuttamaan luokkaa <code>QueryBuilder</code> jotta saat myös jälkimäisen esimerkin toimimaan!
