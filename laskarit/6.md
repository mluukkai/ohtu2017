...
Vastauksen tulisi luonnollisesti olla sama kuin edellä. Jos vastauksesi eroaa aiemmasta mieti missä vika on ja miten joudut muuttamaan luokkaa <code>QueryBuilder</code> jotta saat myös jälkimäisen esimerkin toimimaan!
