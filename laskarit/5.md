...
Testit suositetaan normaaliin tapaan komennolla <code>gradle test</code>

Riko joku testi, esim. edellä listattu muttamalla sen ekspektaatiota:
``` 
...
Hae repositorion <https://github.com/mluukkai/ohtu2017> hakemistossa __viikko5/LyyrakorttiMockito__ oleva projekti. Kyseessä on yksinkertaistettu versio ohjelmoinnin perusteista tutusta tehtävästä Kassapääte ja tyhmä matkakortti.

Tässä tehtävässä on tarkoitus testata ja täydentää luokkaa <code>Kassapaate</code>. **Lyyrakortin koodiin ei tehtävässä saa koskea ollenkaan! Testeissä ei myöskään ole tarkoitus luoda konkreettisia instansseja matkakortista, testien tarvitsemat kortit tulee luoda mockitolla.**
...
Testi ottaa siis kantaa ainoastaan siihen miten kassapääte kutsuu matkakortin metodeja. Lyyrakortin saldoa ei erikseen tarkasteta, sillä oletuksena on, että matkakortin omat testit varmistavat kortin toiminnan.
...
* Spring-versio löytyy <https://github.com/mluukkai/ohtu2017> hakemistossa viikko2/Verkkokauppa3 (xml:llä konfiguroitu) ja viikko2/Verkkokauppa4 (annotaatioilla konfiguroitu)
...
Repositorion <https://github.com/mluukkai/ohtu2017> hakemistosta __viikko5/Tennis__ löytyy ohjelma joka on tarkoitettu tenniksen [pisteenlaskentaan](https://github.com/emilybache/Tennis-Refactoring-Kata#tennis-kata).
...
* viikon 4 [tehtävässä 6](Laskari-4#6-git-t%C3%A4git) palasimme jo menneisyyteen checkouttaamalla tagillä merkittyyn kohtaan
